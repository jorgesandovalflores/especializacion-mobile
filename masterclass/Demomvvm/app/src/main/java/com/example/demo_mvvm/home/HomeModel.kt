...
import com.example.demo_mvvm.ui.theme.BadgeNike
import com.example.demo_mvvm.ui.theme.BadgePepsi
import com.example.demo_mvvm.ui.theme.RowMint
import com.example.demo_mvvm.ui.theme.RowPeach
import kotlinx.coroutines.delay

/**
 * Data/business logic for the Home screen — the Model in MVVM (see
 * references/ui-pattern-mvvm.md in the android-development skill). The
 * ViewModel is the only layer that calls this; it has no knowledge of
 * Compose UI state or the View.
 *
