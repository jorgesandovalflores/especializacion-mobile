...
import com.example.demo_mvc.R
import kotlinx.coroutines.delay

/**
 * Data/business logic for the Home screen — no Android Context, no UI references.
 * Follows the MVC pattern's Model layer (see references/ui-pattern-mvc.md in the
 * android-development skill): the Controller calls this directly, no Presenter mediator.
 *
