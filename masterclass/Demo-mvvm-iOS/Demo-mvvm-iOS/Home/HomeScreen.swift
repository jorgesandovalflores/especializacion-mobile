...
struct HomeRoute: View {
    ...
    var body: some View {
        HomeScreen(
            ...
            onTransactionTap: { viewModel.onTransactionClicked($0) }
        )
    }
}
    ...
    private var mainContent: some View {
        Group {
            ...
            case .success(let data):
                HomeContent(data: data, onTransactionTap: onTransactionTap)
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack(alignment: .top, spacing: 12) {
                    ActivityCard(values: data.activityValues, labels: data.activityLabels)
                ...
                TransactionsSection(transactions: data.transactions, onTransactionTap: onTransactionTap)
            }
            .padding(.horizontal, 20)
            .padding(.top, 16)
            .padding(.bottom, 24)
