...
-   El código está en **Kotlin**, con comentarios explicativos.
-   Ajusta versiones de librerías según tu **BOM** o constraints de proyecto.
-   Integra con tu stack (Room/Retrofit/Hilt) según la arquitectura existente.
